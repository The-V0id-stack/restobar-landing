        ...
        <div className="flex flex-col md:flex-row gap-12">
          <div className="md:w-1/2">
            ...
            <p className="text-lg text-gray-700 mb-8">
              Reserva tu mesa o contáctanos para eventos especiales. Nuestro equipo estará encantado de atenderte.
            </p>
            ...
            <div className="mt-8">
              <h3 className="text-xl font-medium text-gray-900 mb-4">Síguenos</h3>
              <div className="flex space-x-4">
                <a href="#" className="text-gray-700 hover:text-amber-800">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <form>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label htmlFor="guests" className="block text-sm font-medium text-gray-700 mb-1">Personas</label>
                    <select 
                      id="guests" 
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-amber-500 focus:border-amber-500"
                    >
                ...
                <button 
                  type="submit" 
                  className="mt-6 w-full px-6 py-3 bg-amber-800 hover:bg-amber-700 text-white font-medium rounded-lg transition-colors"
                >
                  Reservar Ahora
                </button>
              </form>
